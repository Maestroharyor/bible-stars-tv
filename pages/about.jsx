      ...
      <DefaultLayout title="About Us">
        ...
        <div className="py-20 max-w-[1070px] mx-auto px-5">
          ...
          <div className="text-lg text-center about-main mx-auto max-w-[1000px]">
            ...
            <p>
              These 12 conquerors would become housemates in the{" "}
              <span className="font-bold">BIG HOUSE.</span>
            </p>
            ...
            <p>
              The winner of this season will be awarded a saloon car and
              ₦500,000 cash.
            </p>
            ...
            <p>
              In the big house, the housemates would be treated like royalty.
            ...
            <p>
              ...
              <span className="font-bold">
                {" "}
                Every housemate is at the advantage of getting global
                recognitions.
              </span>{" "}
            </p>
            ...
            <p>
              These housemates would literally become Christian celebrities!!
            </p>
            <p>
            ...
            <p>
              Viewers at home get to join in the entire excitement and win
              prizes. By participating in the home play sessions, and also by
              voting for contestants during the talent hunt sessions.
            </p>
            ...
            <p>
              {"But I tell you, You don't know what we have planned for you."}
            </p>
            ...
            <p className="font-bold">
              This show is for you as long as you believe and love the
              scripture.
            </p>
